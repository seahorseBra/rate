...
public class Helper {
     ...
     */
    public boolean decodeMusicFile(Context context, String musicFileUrl, String decodeFileUrl,
...
//                mediaExtractor.setDataSource(new FileInputStream(musicFileUrl).getFD());
    ...
    private void getDecodeData(MediaExtractor mediaExtractor, MediaCodec mediaCodec,
        ...
        try {
            bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(decodeFileUrl));
...
//                            Constant.ExportByteNumber, convertByteNumberByteArray);
                    ...
                    try {
                        if (decodeOperateInterface != null) {
                            decodeOperateInterface.onDecodeResult(sourceByteArray);
                        }
